    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="max-w-6xl mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-20">
          ...
          <div>
            ...
            <p className="text-gray-400 mb-4">
              Con más de 20 años de trayectoria, en Cafanet y Smarnet360 transformamos la conectividad de hogares y empresas en Ecuador.
            </p>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400 text-sm">
          <p>© {new Date().getFullYear()} InigualitySoft. Todos los derechos reservados.</p>
          <p className="mt-2">
